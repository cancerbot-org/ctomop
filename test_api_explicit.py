...
# Test setting to an explicit number
...
# Test clearing the value (should snap back to computed)
response2 = client.patch(f'/api/patients/{p.id}/', {'relapse_count': ''}, format='json')
