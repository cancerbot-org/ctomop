...
# Unset means the shared service token has staff rights. Set a SMART grant to
# narrow it, or an empty string to deny it everything.
SERVICE_AUTH_SCOPES: str | None = os.environ.get("SERVICE_AUTH_SCOPES")
